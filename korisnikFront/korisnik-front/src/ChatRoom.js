...
class ChatRoom extends Component{
    ...
    componentDidMount(){
        ...
        axios.get("https://localhost:8700/poruke-korisnik-service/poruke/" + agent, { headers: { Authorization: `Bearer ${token}` } })
        .then(res=>{
    ...
    handleSubmit = (e) => {
        ...
        axios.post("https://localhost:8700/poruke-korisnik-service/poruke/posalji", {primalac:vlasnik, sadrzaj:this.state.porukaZaSlanje}, { headers: { Authorization: `Bearer ${token}` } })
            .then(res => {
                console.log(res.data);
                this.setState({
                    porukaZaSlanje:""
