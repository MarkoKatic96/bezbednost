...
class Komentar extends Component{
    ...
    handleSubmit = (e) => {
        ...
        if(this.state.komentar!=""){
            axios.post("https://localhost:8900/rating-service/komentar/", {idSmestaja: smestaj, idRezervacije:rezervacija, idKorisnika:korisnik, komentar:this.state.komentar}, { headers: { Authorization: `Bearer ${token}` } })
            .then(res=>{
    ...
    handleSubmit2 = (e) => {
        ...
        var korisnik = this.props.match.params.korisnikId;
        if(this.state.ocena!=""){
            axios.post("https://localhost:8900/rating-service/ocena/new", {idSmestaj: smestaj, idRezervacija:rezervacija, idKorisnik:korisnik, ocena:this.state.ocena}, { headers: { Authorization: `Bearer ${token}` } })
            .then(res=>{
