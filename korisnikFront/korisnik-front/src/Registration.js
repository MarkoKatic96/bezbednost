...
class Registration extends Component{
    ...
    handleSubmit = (e) => {
        ...
        if(this.state.username!="" && this.state.password!="" && this.state.firstname!="" && this.state.lastname!=""){
            axios.post("https://localhost:8100/korisnik-service/register", {email: this.state.username, lozinka: this.state.password, ime: this.state.firstname, prezime: this.state.lastname})
            .then(res =>{
