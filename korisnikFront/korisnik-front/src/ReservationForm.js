...
class Registration extends Component{
    ...
    handleSubmit = (e) => {
        ...
        if(mydate<mydate2){
            axios.post("https://localhost:8300/reservation-service/rezervisi", {smestajId:idSmestaja, korisnikId:-1, vlasnikId:vlasnik, odDatuma:this.state.datumOd, doDatuma:this.state.datumDo}, { headers: { Authorization: `Bearer ${token}` } })
            .then(res => {
