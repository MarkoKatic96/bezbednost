...
class Home extends Component{
    ...
    componentDidMount() {
        this.setState({
         ...
         axios.get("https://localhost:8600/smestaj-service/smestaj-korisnik/bll")
         .then(res=>{
             this.setState({
                smestaji: res.data
             })
             ...
             smestaji.map(smestaj => {
                axios.get("https://localhost:8600/smestaj-service/smestaj-korisnik/rastojanje/" + smestaj.idSmestaja)
                .then(res=>{
                    var r = new Object();
            ...
            var lista2 = [];
             smestaji.map(smestaj => {
                axios.get("https://localhost:8900/rating-service/ocena/" + smestaj.idSmestaja)
                .then(res=>{
                    var o = new Object();
         ...
         axios.get("https://localhost:8600/smestaj-service/smestaj-korisnik/allTipovi")
         .then(res=>{
        ...
        axios.get("https://localhost:8600/smestaj-service/smestaj-korisnik/allKategorije")
         .then(res=>{
              this.setState({
                kategorije: res.data
              })
        ...
        axios.get("https://localhost:8600/smestaj-service/smestaj-korisnik/allUsluge")
         .then(res=>{
              this.setState({
                dodatne: res.data
              })
        ...
        /*axios.get("https://localhost:8900/rating-service/komentar/all")
         .then(res=>{
              this.setState({
                komentari: res.data
              })
        ...
        axios.get("https://localhost:8100/korisnik-service/korisnici")
            .then(res=>{
                console.log(res.data)
                this.setState({
                    korisnici: res.data
    ...
    komentari = (smestajId)=>{
        axios.get("https://localhost:8900/rating-service/komentar/all/" + smestajId)
         .then(res=>{
              this.setState({
                komentari: res.data
              })
    ...
    handleChangeSort = selectedSort => { //za tip selcet
        ...
        axios({
            url: "https://localhost:8200/pretraga-service/sort/" + selectedSort.value,
            method: 'post',
    ...
    handleSubmit = (e) => {
        e.preventDefault();
            axios.post("https://localhost:8200/pretraga-service/pretraga", {mesto: this.state.mesto, brojOsoba: this.state.brojOsoba, datumDolaska: this.state.datumOd, datumPolaska: this.state.datumDo, tipSmestaja:this.state.selectedTip.value, kategorijaSmestaja: this.state.selectedKategorija.value, dodatneUsluge: this.state.selectedUsluge, udaljenost: this.state.udaljenostP})
            .then(res => {
                this.setState({
                    smestaji: res.data
                })
    ...
    rastojanje = (idSmestaja) =>{
        axios.get("https://localhost:8600/smestaj-service/smestaj-korisnik/rastojanje/" + idSmestaja)
        .then(res => {
            this.setState({
                rastojanja:res.data
            })
