...
public class AgentValidator implements Validator<com.megatravel.agentlocalbackend.wsdl.GetAgentByEmailResponse.Agent> {

	@Override
	public Valid validate(com.megatravel.agentlocalbackend.wsdl.GetAgentByEmailResponse.Agent t) {
		if (t==null) {
